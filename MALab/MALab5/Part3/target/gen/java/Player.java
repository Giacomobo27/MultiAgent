...
public class Player extends ASTRAClass {
	public Player() {
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {170,28,170,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {170,30,170,35},
						Primitive.newPrimitive(1)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {171,28,171,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {171,30,171,35},
						Primitive.newPrimitive(2)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {172,28,172,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {172,30,172,35},
						Primitive.newPrimitive(3)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {173,28,173,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {173,30,173,35},
						Primitive.newPrimitive(4)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {174,28,174,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {174,30,174,35},
						Primitive.newPrimitive(5)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {175,28,175,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {175,30,175,35},
						Primitive.newPrimitive(6)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {176,28,176,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {176,30,176,35},
						Primitive.newPrimitive(7)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {177,28,177,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {177,30,177,35},
						Primitive.newPrimitive(8)
					)
				}
			)
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {178,28,178,35},
				new Statement[] {
					new Assignment(
						new Variable(Type.INTEGER, "L"),
						"Player", new int[] {178,30,178,35},
						Primitive.newPrimitive(9)
					)
				}
			)
