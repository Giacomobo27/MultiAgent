...
public class Shared extends ASTRAClass {
	public Shared() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Shared", new int[] {61,36,79,5},
				new Statement[] {
					new ForEach(
						"Shared", new int[] {64,8,79,5},
						...
						new Block(
							"Shared", new int[] {64,53,78,9},
							new Statement[] {
								new Declaration(
									new Variable(Type.LIST, "required_actions"),
									"Shared", new int[] {66,12,78,9},
									new ListTerm(new Term[] {

									})
								),
								new Query(
									"Shared", new int[] {68,12,68,65},
									new ModuleFormula("hypermedia",
								...
								new ForEach(
									...
									new Block(
										"Shared", new int[] {72,73,75,13},
										new Statement[] {
											new Query(
												"Shared", new int[] {73,16,73,74},
												new ModuleFormula("hypermedia",
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Shared", new int[] {85,36,94,5},
				new Statement[] {
					new ForEach(
						"Shared", new int[] {87,8,94,5},
						new ModuleFormula("hypermedia",
						...
						new Block(
							"Shared", new int[] {87,53,93,9},
							new Statement[] {
								new Declaration(
									new Variable(Type.STRING, "link_url"),
									"Shared", new int[] {90,12,93,9},
									Primitive.newPrimitive("")
								),
								new Query(
									"Shared", new int[] {91,12,91,63},
									new ModuleFormula("hypermedia",
										new Predicate("hasTarget", new Term[] {
