...
public class Player extends ASTRAClass {
	public Player() {
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {68,4,83,5},
				new Statement[] {
					new If(
						"Player", new int[] {70,8,83,5},
						new AND(
							new ModuleFormula("ttt",
								new Predicate("TicTacToeResult", new Term[] {
									new Variable(Type.STRING, "url"),
									new Variable(Type.STRING, "winner_agent",false)
								}),
								new ModuleFormulaAdaptor() {
									public Formula invoke(BindingsEvaluateVisitor visitor, Predicate predicate) {
							...
							new ModuleFormula("strings",
								new Predicate("contains", new Term[] {
									new Variable(Type.STRING, "winner_agent"),
						...
						new Block(
							"Player", new int[] {71,60,74,9},
							new Statement[] {
								new ModuleCall("console",
									"Player", new int[] {72,12,72,54},
								...
								new Send("Player", new int[] {73,12,73,77},
									new Performative("inform"),
									Primitive.newPrimitive("http://localhost:9000/main"),
					...
					new If(
						...
						new Block(
							"Player", new int[] {77,60,80,9},
							new Statement[] {
								new ModuleCall("console",
									"Player", new int[] {78,12,78,54},
									new Predicate("println", new Term[] {
										Operator.newOperator('+',
											Primitive.newPrimitive("winner: "),
											new Variable(Type.STRING, "winner_agent")
								...
								new Send("Player", new int[] {79,12,79,77},
									new Performative("inform"),
									Primitive.newPrimitive("http://localhost:9000/main"),
									new Predicate("winner", new Term[] {
										Primitive.newPrimitive("OPlayerRole")
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {85,94,109,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {87,8,87,60},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
					...
					new ForEach(
						"Player", new int[] {95,8,109,5},
						new Predicate("link_actions", new Term[] {
							new Variable(Type.STRING, "anyLink",false)
						}),
						new Block(
							"Player", new int[] {95,46,99,9},
							new Statement[] {
								new If(
									"Player", new int[] {96,12,99,9},
									new ModuleFormula("strings",
										new Predicate("contains", new Term[] {
									...
									new Block(
										"Player", new int[] {96,52,98,13},
										new Statement[] {
											new ModuleCall("knowledgeStoreGame",
												"Player", new int[] {97,16,97,67},
												new Predicate("getKnowledge", new Term[] {
													new Variable(Type.STRING, "anyLink"),
													Primitive.newPrimitive("JSON-LD")
												}),
					...
					new If(
						...
						new Block(
							"Player", new int[] {100,167,108,9},
							new Statement[] {
								new Declaration(
									new Variable(new ObjectType(JsonNode.class), "bodyJson"),
									"Player", new int[] {101,12,108,9},
								...
								new ModuleCall("console",
									"Player", new int[] {106,12,106,57},
									new Predicate("println", new Term[] {
										Operator.newOperator('+',
											Primitive.newPrimitive("Square in play "),
											new Variable(Type.STRING, "form_url")
										)
									}),
									new DefaultModuleCallAdaptor() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {111,46,115,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {112,8,112,60},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
								Primitive.newPrimitive("Processed information from "),
								new Variable(Type.STRING, "url")
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {119,92,122,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {120,8,120,35},
						new Predicate("println", new Term[] {
							Primitive.newPrimitive("results:")
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
								return true;
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {134,4,161,5},
				new Statement[] {
					new Declaration(
						new Variable(new ObjectType(JsonNode.class), "bodyJson"),
						"Player", new int[] {137,8,161,5},
						new ModuleTerm("builder", new ObjectType(com.fasterxml.jackson.databind.JsonNode.class),
							new Predicate("createObject", new Term[] {}),
							new ModuleTermAdaptor() {
								public Object invoke(Intention intention, Predicate predicate) {
					...
					new TryRecover(
						"Player", new int[] {142,8,161,5},
						new Block(
							"Player", new int[] {142,12,154,9},
							new Statement[] {
								new If(
									"Player", new int[] {144,12,154,9},
									new Comparison("==",
										new Variable(Type.STRING, "http_method"),
										Primitive.newPrimitive("POST")
									),
									new Block(
										"Player", new int[] {144,38,147,13},
										new Statement[] {
											new ScopedSubgoal(
												"Player", new int[] {145,16,147,13},
												"MAMSAgent",
												new Goal(
								...
								new If(
									"Player", new int[] {149,12,154,9},
									new Comparison("==",
										new Variable(Type.STRING, "http_method"),
										Primitive.newPrimitive("PUT")
									),
									new Block(
										"Player", new int[] {149,37,152,13},
										new Statement[] {
											new ScopedSubgoal(
												"Player", new int[] {150,16,152,13},
												"MAMSAgent",
												new Goal(
													new Predicate("put", new Term[] {
														new Variable(Type.STRING, "form_url"),
						...
						new Block(
							"Player", new int[] {154,18,161,5},
							new Statement[] {
								new SpecialBeliefUpdate(
									"Player", new int[] {155,12,158,9},
									new Predicate("http_fail_count", new Term[] {
										Operator.newOperator('+',
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {167,71,170,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {168,8,168,59},
						new Predicate("println", new Term[] {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {179,30,188,5},
				new Statement[] {
					new ModuleCall("knowledgeStoreGame",
						"Player", new int[] {180,8,180,34},
					...
					new ForEach(
						...
						new Block(
							"Player", new int[] {182,81,184,9},
							new Statement[] {
								new BeliefUpdate('-',
									"Player", new int[] {183,12,184,9},
									new Predicate("form_actions", new Term[] {
					...
					new ForEach(
						"Player", new int[] {185,8,188,5},
						new Predicate("link_actions", new Term[] {
							new Variable(Type.STRING, "anyLink",false)
						}),
						new Block(
							"Player", new int[] {185,46,187,9},
							new Statement[] {
								new BeliefUpdate('-',
									"Player", new int[] {186,12,187,9},
									new Predicate("link_actions", new Term[] {
										new Variable(Type.STRING, "anyLink")
									})
								)
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {190,88,197,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {192,8,192,110},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {199,53,203,5},
				new Statement[] {
					new ModuleCall("console",
						"Player", new int[] {201,8,201,34},
						new Predicate("println", new Term[] {
							Primitive.newPrimitive("my turn")
						}),
						new DefaultModuleCallAdaptor() {
							public boolean inline() {
								return true;
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {206,81,209,5},
				new Statement[] {
					new ModuleCall("knowledgeStoreGame",
						"Player", new int[] {208,8,208,70},
						new Predicate("getKnowledge", new Term[] {
							Operator.newOperator('+',
								new Variable(Type.STRING, "url"),
								Operator.newOperator('+',
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {212,4,215,5},
				new Statement[] {
					new Subgoal(
						"Player", new int[] {213,8,215,5},
						new Goal(
							new Predicate("clear_knowledge", new Term[] {})
						)
					),
					new Send("Player", new int[] {214,8,214,42},
						new Performative("inform"),
						new Variable(Type.STRING, "opponent"),
						new Predicate("turn", new Term[] {
							Primitive.newPrimitive(true)
