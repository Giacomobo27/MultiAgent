...
public class Main extends ASTRAClass {
	public Main() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Main", new int[] {137,64,139,5},
				new Statement[] {
					new ModuleCall("console",
						"Main", new int[] {138,8,138,44},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
